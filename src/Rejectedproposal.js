...
export default function Rejectedproposal() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      // Filter only the "Rejected" proposals
      ...
      <div id="content-wrapper" className="d-flex flex-column">
        <div id="content">
          ...
          <div className="container-fluid">
            <h1 className="h3 mb-2 text-gray-800">Rejected Proposal</h1>
            <p className="mb-4">
              Halaman ini berisi list pengajuan judul proposal mahasiswa yang
              tidak disetujui!
            </p>
